...
from openstl.modules.morlstm_modules import STconvert

# class MorLSTM_D_Model(nn.Module):
#     r"""SwinLSTM 
...
#         super(MorLSTM_D_Model, self).__init__()
...
class MorLSTM_B_Model(nn.Module):
    def __init__(self, configs, **kwargs):
        super(MorLSTM_B_Model, self).__init__()
        T, C, H, W = configs.in_shape
        assert H == W, 'Only support H = W for image input'
        self.configs = configs
