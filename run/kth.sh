...
nohup python tools/train.py -d kth -c configs/kth/ModPredFormer.py --ex_name work_dirs/kth/predformer/facTSattion_onecycle_dim128_head4_mod0_1_ndepth8_patch2_tauloss_routerloss -b 2 -vb 2 --lr 2.5e-4 > train1.log &